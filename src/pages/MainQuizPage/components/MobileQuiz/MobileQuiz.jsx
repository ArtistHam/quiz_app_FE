...
const MobileQuiz = ({
  ...
  return (
    <div className={styles.mobileQuizContainer}>
      <div
        className={styles.mobileMediaFrame}
        style={{ borderColor: borderColor }}
      >
        {isVideo ? (
          <video
            key={questionCount}
            className={`${styles.media} ${answered ? styles.blurred : ""}`}
            controls
          >
          ...
          <img
            ...
            src={currentFile.url}
            alt="question"
            className={`${styles.image} ${answered ? styles.blurred : ""}`}
          />
        )}
      ...
      {answered ? (
        <div className={styles.answerButtonsMobile}>
          <Button variant="quiz-mobile-next" onClick={onNext}>
            Next
          </Button>
        </div>
      ) : (
        <div className={styles.answerButtonsMobile}>
          <Button variant="quiz-mobile" onClick={() => handleAnswer("real")}>
            Real
          </Button>
          <Button variant="quiz-mobile" onClick={() => handleAnswer("fake")}>
            Fake
          </Button>
        </div>
      )}
